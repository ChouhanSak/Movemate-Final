  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, async (snap) => {
      ...
      const filtered = list.filter(
        (p) => p.releaseAt && p.bookingStatus === "COMPLETED"
      );
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2 text-sm text-gray-600">
                  ...
                  <p>
                    ...
                    {p.releaseAt && p.releaseAt.toDate
              ...
              <div className="flex flex-col items-end justify-between min-w-[180px]">
                ...
                {p.paymentStatus !== "released" && (
                  <button
                    ...
                    className="mt-3 px-5 py-2 rounded-xl text-white bg-gradient-to-r from-emerald-600 to-green-500 hover:scale-105 transition shadow-md"
                  >
                    Release to Agency
                  </button>
                )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl w-full max-w-2xl p-6 relative">
            ...
            <div className="mt-6 border rounded-xl p-5 bg-gradient-to-r from-green-50 to-blue-50">
              ...
              <p className="text-sm text-gray-500">
                Release At:{" "}
                {selectedPayment.releaseAt &&
                selectedPayment.releaseAt.toDate
                  ? selectedPayment.releaseAt
                      .toDate()
                      .toLocaleString()
                  : "N/A"}
